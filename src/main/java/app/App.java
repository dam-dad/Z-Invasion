...
import ui.LevelEndScene.LevelTimeData;
...
//	private static final boolean SHOW_BG = false;
	...
	private void setLevel(int levelNum) {
		...
		/**/
		String levelFile = "/assets/levels/Level" + levelNum + ".tmx";

		Level level = new TMXLevelLoader().load(TMXLevelLoader.class.getResource(levelFile), getGameWorld());
...
//
//		LevelTimeData levelTimeData = new ui.LevelEndScene.LevelTimeData(shortestTime * 2.4, shortestTime * 1.3, shortestTime);
//
//		set("levelTimeData", levelTimeData);
	...
	protected void initGame() {
		...
		// debemos spawnear al jugador despues de next level, de lo contrario, el
